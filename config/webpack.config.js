...
module.exports = function(webpackEnv) {
  ...
  const getStyleLoaders = (cssOptions, preProcessor) => {
    ...
    //   );
    // }
    // 自定义主题    package.json下  babel plugins  里的 style:"css" 改为 style: true
    if (preProcessor) {
  ...
  // "cheap-module-source-map"  改为  "cheap-module-eval-source-map",
  return {
    mode: isEnvProduction ? "production" : isEnvDevelopment && "development",
    // Stop compilation early in production
    bail: isEnvProduction,
    devtool: isEnvProduction ? (shouldUseSourceMap ? "source-map" : false) : isEnvDevelopment && "cheap-module-eval-source-map",
